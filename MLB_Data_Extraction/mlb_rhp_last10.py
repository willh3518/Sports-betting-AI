...
"""
mlb_rhp_last10.py
For each non-pitcher in mlb_prizepicks.csv, fetch their vs-RHP stats for last 10 games from StatMuse
and extract only G, AB, H, HR, RBI, PA, AVG, OBP, SLG & OPS. Writes mlb_vs_rhp_last10.csv.
"""
...
OUTPUT_CSV = os.path.join(CSV_FOLDER, "mlb_vs_rhp_last10.csv")

# StatMuse URL template
STATMUSE_URL = "https://www.statmuse.com/mlb/ask/{slug}-vs-right-handed-pitchers-last-10-games"

...
"""
mlb_rhp_avg.py
For each non-pitcher in mlb_prizepicks.csv, fetch their vs-RHP stats for this season from StatMuse
and extract only G, AB, H, HR, RBI, PA, AVG, OBP, SLG & OPS. Writes mlb_vs_rhp_avg.csv.
"""
...
OUTPUT_CSV = os.path.join(CSV_FOLDER, "mlb_vs_rhp_avg.csv")

# StatMuse URL template
STATMUSE_URL = "https://www.statmuse.com/mlb/ask/{slug}-vs-right-handed-pitchers-this-season"

...
"""
mlb_lhp_avg.py
For each non-pitcher in mlb_prizepicks.csv, fetch their vs-LHP stats for this season from StatMuse
and extract only G, AB, H, HR, RBI, PA, AVG, OBP, SLG & OPS. Writes mlb_vs_lhp_avg.csv.
"""
...
OUTPUT_CSV = os.path.join(CSV_FOLDER, "mlb_vs_lhp_avg.csv")

# StatMuse URL template
STATMUSE_URL = "https://www.statmuse.com/mlb/ask/{slug}-vs-left-handed-pitchers-this-season"

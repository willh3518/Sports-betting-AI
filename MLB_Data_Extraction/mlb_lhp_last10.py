...
"""
mlb_lhp_last10.py
For each non-pitcher in mlb_prizepicks.csv, fetch their vs-LHP stats for last 10 games from StatMuse
and extract only G, AB, H, HR, RBI, PA, AVG, OBP, SLG & OPS. Writes mlb_vs_lhp_last10.csv.
"""

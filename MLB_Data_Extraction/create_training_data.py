...
HITTER_OUTPUT = os.path.join(MLB_DATA_DIR, "MLB_Training_Data/hitter_training_data.csv")
PITCHER_OUTPUT = os.path.join(MLB_DATA_DIR, "MLB_Training_Data/pitcher_training_data.csv")
